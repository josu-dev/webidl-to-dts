<script lang="ts">
  ...
  let is_pending_update = false;

  async function transpile() {
    // is_converting = true;
    // const r = await converter.convert(raw_webidl);
    // raw_dts = r;
    // is_converting = false;
  }
...
<div class="flex">
  <form action="?/idl_to_dts" method="post">
  <textarea name="idl" id="" bind:value={raw_dts}></textarea>
